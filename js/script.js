    ...
    companies.forEach(company => {
        ...
        companyCard.innerHTML = `
            ...
            <div class="company-info">
                ...
                <p class="company-products-count">${company.products.length} منتجات</p>
                <a href="#" class="view-btn" data-id="${company.id}">عرض التفاصيل</a>
            </div>
        `;
...
function renderCompany(companyId) {
    ...
    companyHeader.innerHTML = `
        ...
        <div class="company-header-info">
            ...
            <p class="company-header-total">إجمالي 2024: $${company.total2024.toLocaleString()}</p>
    ...
    sortedProducts.forEach(product => {
        ...
        const hasPatientData = product.patients_q1 !== undefined;
        ...
        productCard.innerHTML = `
            ...
            <div class="data-grid">
                <div class="data-section">
                    <h4 class="data-title">المشتريات ($)</h4>
                    <div class="quarters-grid">
                        <div class="quarter-item">
                            <div class="quarter-label">الربع الأول</div>
...
function renderCharts(company) {
    ...
    // Calculate quarterly totals for purchases
    ...
    if (matchingCompanies.length === 0 && matchingProducts.length === 0) {
        ...
        if (matchingCompanies.length > 0) {
            ...
            companiesSection.innerHTML = `
                <h3 style="margin-bottom: 0.5rem;">الشركات (${matchingCompanies.length})</h3>
            ...
            matchingCompanies.forEach(company => {
                ...
                companyCard.innerHTML = `
                    ...
                    <div class="company-info">
                        <h3 class="company-name">${company.name}</h3>
                        <p class="company-products-count">${company.products.length} منتجات</p>
                        <a href="#" class="view-btn" data-id="${company.id}">عرض</a>
                    </div>
                `;
                companiesGrid.appendChild(companyCard);
            });
        ...
        if (matchingProducts.length > 0) {
            ...
            productsSection.innerHTML = `
                <h3 style="margin-bottom: 0.5rem;">المنتجات (${matchingProducts.length})</h3>
            ...
            matchingProducts.forEach(product => {
                ...
                productCard.innerHTML = `
                    ...
                    <a href="#" class="view-btn" style="display: block; margin-top: 0.5rem; text-align: center;" 
                       data-id="${product.companyId}">عرض الشركة</a>
                `;
                productsContainer.appendChild(productCard);
            });
...
function showHomePage() {
    // Reset page title
    pageTitle.textContent = 'المشتريات الصيدلانية';
